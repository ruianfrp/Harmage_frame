...
public class MilestoneServiceImp implements MilestoneService {
    ...
    @Override
    public Set<String> selectStatus(String project_id) {
        return milestoneDao.selectStatus(project_id);
    }

    @Override
    public void updateProjectStatus(String projectStatus, String projectSubState, Integer project_id) {
        milestoneDao.updateProjectStatus(projectStatus, projectSubState, project_id);
    }
