...
public class ExportExcel<T extends Serializable> {
    ...
    public void InsertData() {
        log.info("Begin to export data to project");
        ...
        log.info("Success to export data to project");
    ...
    public String getTypeChangeValue(TableCell excelElement)
        ...
        Object colName = excelElement.get_name();
        Object colValue = excelElement.get_value();
        String retValue = "";
        if (colValue==""){
            return null;
        }
